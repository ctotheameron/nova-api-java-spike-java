...
package com.nova_api_java_spike.api.client.okhttp

import com.fasterxml.jackson.databind.json.JsonMapper
import com.nova_api_java_spike.api.client.NovaApiJavaSpikeClientAsync
import com.nova_api_java_spike.api.client.NovaApiJavaSpikeClientAsyncImpl
import com.nova_api_java_spike.api.core.ClientOptions
import com.nova_api_java_spike.api.core.Sleeper
import com.nova_api_java_spike.api.core.Timeout
import com.nova_api_java_spike.api.core.http.Headers
import com.nova_api_java_spike.api.core.http.HttpClient
...
/**
 * A class that allows building an instance of [NovaApiJavaSpikeClientAsync] with [OkHttpClient] as
 * the underlying [HttpClient].
 */
class NovaApiJavaSpikeOkHttpClientAsync private constructor() {

    companion object {

        /**
         * Returns a mutable builder for constructing an instance of [NovaApiJavaSpikeClientAsync].
         */
         ...
         */
        @JvmStatic fun fromEnv(): NovaApiJavaSpikeClientAsync = builder().fromEnv().build()
    }

    /** A builder for [NovaApiJavaSpikeOkHttpClientAsync]. */
    class Builder internal constructor() {
         ...
         *
         * Defaults to [com.nova_api_java_spike.api.core.jsonMapper]. The default is usually
        ...
        /**
         * Returns an immutable instance of [NovaApiJavaSpikeClientAsync].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): NovaApiJavaSpikeClientAsync =
            NovaApiJavaSpikeClientAsyncImpl(
                clientOptions
                    .httpClient(
