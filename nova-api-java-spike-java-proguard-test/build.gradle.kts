...
dependencies {
    testImplementation(project(":nova-api-java-spike-java"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../nova-api-java-spike-java-core/src/main/resources/META-INF/proguard/nova-api-java-spike-java-core.pro")
}
...
val testProGuard by tasks.registering(JavaExec::class) {
    ...
    mainClass.set("com.nova_api_java_spike.api.proguard.ProGuardCompatibilityTest")
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../nova-api-java-spike-java-core/src/main/resources/META-INF/proguard/nova-api-java-spike-java-core.pro",
