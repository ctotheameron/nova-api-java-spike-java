...
/**
 * A client for interacting with the Nova API Java Spike REST API asynchronously. You can also
 ...
 * may call [close].
 */
interface NovaApiJavaSpikeClientAsync {
     ...
     * this client.
     */
    fun sync(): NovaApiJavaSpikeClient
     ...
     */
    fun withOptions(modifier: Consumer<ClientOptions.Builder>): NovaApiJavaSpikeClientAsync
    ...
    /**
     * A view of [NovaApiJavaSpikeClientAsync] that provides access to raw HTTP responses for each
     * method.
     */
