...
/**
 * A client for interacting with the Angellist Nova Java Spike REST API asynchronously. You can also
 ...
 * may call [close].
 */
interface AngellistNovaJavaSpikeClientAsync {
     ...
     * this client.
     */
    fun sync(): AngellistNovaJavaSpikeClient
     ...
     */
    fun withOptions(modifier: Consumer<ClientOptions.Builder>): AngellistNovaJavaSpikeClientAsync
    ...
    /**
     * A view of [AngellistNovaJavaSpikeClientAsync] that provides access to raw HTTP responses for
     * each method.
     */
