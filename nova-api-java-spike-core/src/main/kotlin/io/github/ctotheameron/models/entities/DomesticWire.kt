...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [DomesticWire].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(domesticWire: DomesticWire) = apply {
            ...
            additionalProperties = domesticWire.additionalProperties.toMutableMap()
        }
    ...
    fun validate(): DomesticWire = apply {
        ...
        _type().let {
            if (it != JsonValue.from("domestic_wire")) {
                throw NovaApiJavaSpikeInvalidDataException("'type' is invalid, received $it")
            }
        }
        branchCode()
        intermediaryPartyName()
