...
import com.nova_api_java_spike.api.client.okhttp.OkHttpClient
        ...
        val failingHttpClient =
            object : HttpClient {
                override fun execute(
                    ...
                    callCount++
                    if (callCount == 1) {
                        throw NovaApiJavaSpikeRetryableException("Simulated retryable failure")
                    }
                ...
                override fun executeAsync(
                    ...
                    if (callCount == 1) {
                        ...
                        future.completeExceptionally(
                            NovaApiJavaSpikeRetryableException("Simulated retryable failure")
                        )
                        return future
                    }
