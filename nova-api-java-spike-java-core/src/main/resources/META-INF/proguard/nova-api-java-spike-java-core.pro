...
-keep @com.fasterxml.jackson.databind.annotation.JsonSerialize class com.nova_api_java_spike.api.** { *; }
-keep @com.fasterxml.jackson.databind.annotation.JsonDeserialize class com.nova_api_java_spike.api.** { *; }

# Jackson uses reflection to serialize and deserialize our classes based on their constructors and annotated members.
-keepclassmembers class com.nova_api_java_spike.api.** {
    <init>(...);
