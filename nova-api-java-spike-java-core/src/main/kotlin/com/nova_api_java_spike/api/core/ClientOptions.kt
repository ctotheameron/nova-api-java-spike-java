...
import com.nova_api_java_spike.api.core.http.PhantomReachableClosingHttpClient
import com.nova_api_java_spike.api.core.http.QueryParams
import com.nova_api_java_spike.api.core.http.RetryingHttpClient
...
private constructor(
     ...
     *
     * Use the one published in `nova-api-java-spike-java-client-okhttp` or implement your own.
     *
     ...
     *
     * Defaults to [com.nova_api_java_spike.api.core.jsonMapper]. The default is usually sufficient
    ...
    class Builder internal constructor() {
        ...
        fun fromEnv() = apply {
            (System.getProperty("novaapijavaspike.baseUrl")
                ...
                ?.let { baseUrl(it) }
            (System.getProperty("novaapijavaspike.apiKey")
                    ?: System.getenv("NOVA_API_JAVA_SPIKE_API_KEY"))
                ?.let { apiKey(it) }
        }
